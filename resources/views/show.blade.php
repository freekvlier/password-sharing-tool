<x-layout>
    <section class="text-gray-600 body-font relative lg:w-1/2 md:w-2/3 mx-auto">
        <div class="flex justify-center container px-5 py-24 mx-auto ">
            ...
            <div
                class="flex flex-col w-full justify-center rounded-lg bg-white p-10 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                <div class="flex flex-col text-center w-full mb-12">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Shared Password</h1>
                </div>
                <div class="relative mb-4">
                    <label for="password" class="mb-2 inline-block text-neutral-700 dark:text-neutral-200">
                        Password
                    </label>
                    <div class="flex">
                        <div class="relative mb-3 w-full" data-te-input-wrapper-init>
                            <input readonly type="text"
                                ...
                                id="copy-target" value="{{ $decrypted_password }}" />
                        </div>
                        <div>
